...
import 'AssignQuestionsPage.dart';
import 'AssignSubmissionsPage.dart';
...
class _ProfilePageState extends State<ProfilePage> {
      ...
      trailing: Row(
        children: <Widget>[
          IconButton(
            ...
            onPressed: () async { 
              assignQInfo = await _queryAssignInfo(courseID);
              Navigator.of(context).push(
                MaterialPageRoute(builder: (context) => 
                AssignQuestionsPage(userinfo.email, courseID, assignQInfo))
              );
            },
          ),
          IconButton(
  ...
  Future<List<AssignmentQuestionInfo>> _queryAssignInfo(String courseID) async {
